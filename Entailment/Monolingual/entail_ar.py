...
Original file is located at
    https://colab.research.google.com/drive/1Wkmt7ePDby4wWkkuIGv1JSMvypuu1NpY
"""
...
# Label prompts
prompts = {
    0: "هذا النص لا يحتوي على الكراهية",
    1: "هذا النص يحتوي على الكراهية"
}
...
def get_input_pairs(texts, labels):
    ...
    for text, label in zip(texts, labels):
        text_pair = text + " [سبتمبر] " + prompts[label]
