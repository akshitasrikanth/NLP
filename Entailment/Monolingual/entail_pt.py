...
Original file is located at
    https://colab.research.google.com/drive/1skd8RDYCThAGUmWu9qorvuHrkuqPf9Ef
"""
...
# Label prompts
prompts = {
    0: "Este texto não contém ódio",
    1: "Este texto contém ódio"
}
...
def get_input_pairs(texts, labels):
    ...
    for text, label in zip(texts, labels):
        text_pair = text + " [SET] " + prompts[label]
